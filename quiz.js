...
var takeQuiz = function ($) {
	var _ASF$criteria, _ref5, _ASF$interventions, _AI$criteria, _ref14, _ref16, _AI$interventions, _GFI$criteria, _ref18, _ref20, _ref22, _GFI$interventions, _THL$criteria, _ref24, _THL$interventions, _Faun$criteria, _Faun$interventions, _CIWF$criteria, _ref35, _CIWF$interventions, _FIAPO$criteria, _ref40, _FIAPO$interventions, _SVB$criteria, _ref42, _ref43, _SVB$interventions, _SA$criteria, _SA$interventions;
	...
	var Intervention = function () {
		function Intervention() {
			...
			if (arguments.length == 1) {
				...
				try {
					for (var _iterator4 = Object.entries(arguments.length <= 0 ? undefined : arguments[0])[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						var _step4$value = _slicedToArray(_step4.value, 2);

						var outcome = _step4$value[0];
		...
		_createClass(Intervention, [{
			...
			value: function score(weights) {
				...
				try {
					for (var _iterator5 = Object.entries(this.effect_on_outcomes)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
						var _step5$value = _slicedToArray(_step5.value, 2);

						var key = _step5$value[0];
						var effect = _step5$value[1];
	...
	var Charity = function () {
		...
		_createClass(Charity, [{
			...
			value: function applyNeglectedCountryBonus(weight) {
				...
				try {
					for (var _iterator6 = Object.values(this.interventions)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
						var intervention = _step6.value;
						var _iteratorNormalCompletion7 = true;
						var _didIteratorError7 = false;
						var _iteratorError7 = undefined;

						try {
							for (var _iterator7 = Object.entries(intervention.effect_on_outcomes)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
								var _step7$value = _slicedToArray(_step7.value, 2);

								var outcome = _step7$value[0];
								var effect = _step7$value[1];
			...
			value: function scoreInterventions(weights) {
				...
				try {
					for (var _iterator9 = Object.entries(this.interventions)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
			...
			set: function set(value) {
				...
				this._links = value;
				Object.defineProperty(this._links, "comprehensive_review", { get: function get() {
						return _this6.links.review + "/#comprehensive-review";
					} });
	...
	ASF.criteria = (_ASF$criteria = {}, _defineProperty(_ASF$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(STRONG, MODERATE)), _defineProperty(_ASF$criteria, COST_OF_EXPANSION_PLANS, new Criterion(AVERAGE, LOW)), _defineProperty(_ASF$criteria, TRACK_RECORD, new Criterion(STRONG, MODERATE)), _defineProperty(_ASF$criteria, COST_EFFECTIVENESS, new Criterion(AVERAGE, MODERATE)), _defineProperty(_ASF$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(STRONG, MODERATE)), _defineProperty(_ASF$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(STRONG, MODERATE)), _defineProperty(_ASF$criteria, CULTURE_AND_STRUCTURE, new Criterion(AVERAGE, HIGH)), _ASF$criteria);

	ASF.interventions = (_ASF$interventions = {}, _defineProperty(_ASF$interventions, GRASSROOTS_PROJECTS, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 1))), _defineProperty(_ASF$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 1 + 1))), _defineProperty(_ASF$interventions, RESEARCH, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2))), _defineProperty(_ASF$interventions, CORPORATE_OUTREACH, new Intervention((_ref5 = {}, _defineProperty(_ref5, INFLUENCING_INDUSTRY, 2 * 2), _defineProperty(_ref5, BUILDING_ALLIANCES, 2 * 2), _ref5))), _defineProperty(_ASF$interventions, LEGAL_WORK, new Intervention(_defineProperty({}, INFLUENCING_POLICY_AND_THE_LAW, 2 * 2))), _defineProperty(_ASF$interventions, MOVEMENT_STRENGTHENING, new Intervention(_defineProperty({}, BUILDING_ALLIANCES, 1))), _ASF$interventions);
	...
	AI.criteria = (_AI$criteria = {}, _defineProperty(_AI$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(STRONG, MODERATE)), _defineProperty(_AI$criteria, COST_OF_EXPANSION_PLANS, new Criterion(AVERAGE, LOW)), _defineProperty(_AI$criteria, TRACK_RECORD, new Criterion(STRONG, MODERATE)), _defineProperty(_AI$criteria, COST_EFFECTIVENESS, new Criterion(STRONG, MODERATE)), _defineProperty(_AI$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(AVERAGE, LOW)), _defineProperty(_AI$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(STRONG, HIGH)), _defineProperty(_AI$criteria, CULTURE_AND_STRUCTURE, new Criterion(STRONG, HIGH)), _AI$criteria);

	AI.interventions = (_AI$interventions = {}, _defineProperty(_AI$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 1 + 2 * 1))), _defineProperty(_AI$interventions, RESEARCH, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2))), _defineProperty(_AI$interventions, CORPORATE_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_INDUSTRY, 2 * 2))), _defineProperty(_AI$interventions, LEGAL_WORK, new Intervention(_defineProperty({}, INFLUENCING_POLICY_AND_THE_LAW, 1))), _defineProperty(_AI$interventions, INVESTIGATIONS, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 2))), _defineProperty(_AI$interventions, MOVEMENT_STRENGTHENING, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2 * 2))), _defineProperty(_AI$interventions, INCREASE_VEGAN_OPTIONS, new Intervention((_ref14 = {}, _defineProperty(_ref14, INFLUENCING_INDUSTRY, 2), _defineProperty(_ref14, BUILDING_ALLIANCES, 1), _ref14))), _defineProperty(_AI$interventions, GOVERNMENT_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_POLICY_AND_THE_LAW, 2))), _defineProperty(_AI$interventions, ORGANISING_CONFERENCES_AND_EVENTS, new Intervention((_ref16 = {}, _defineProperty(_ref16, INFLUENCING_PUBLIC_OPINION, 0.5), _defineProperty(_ref16, BUILDING_ALLIANCES, 0.5), _ref16))), _AI$interventions);
	...
	GFI.criteria = (_GFI$criteria = {}, _defineProperty(_GFI$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(STRONG, LOW)), _defineProperty(_GFI$criteria, COST_OF_EXPANSION_PLANS, new Criterion(STRONG, HIGH)), _defineProperty(_GFI$criteria, TRACK_RECORD, new Criterion(AVERAGE, LOW)), _defineProperty(_GFI$criteria, COST_EFFECTIVENESS, new Criterion(STRONG, LOW)), _defineProperty(_GFI$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(AVERAGE, LOW)), _defineProperty(_GFI$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(AVERAGE, MODERATE)), _defineProperty(_GFI$criteria, CULTURE_AND_STRUCTURE, new Criterion(STRONG, MODERATE)), _GFI$criteria);

	GFI.interventions = (_GFI$interventions = {}, _defineProperty(_GFI$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 2))), _defineProperty(_GFI$interventions, RESEARCH, new Intervention((_ref18 = {}, _defineProperty(_ref18, INFLUENCING_INDUSTRY, 2), _defineProperty(_ref18, CAPACITY_BUILDING, 2), _ref18))), _defineProperty(_GFI$interventions, LEGAL_WORK, new Intervention(_defineProperty({}, INFLUENCING_INDUSTRY, 0.5))), _defineProperty(_GFI$interventions, INCREASE_VEGAN_OPTIONS, new Intervention((_ref20 = {}, _defineProperty(_ref20, INFLUENCING_INDUSTRY, 2), _defineProperty(_ref20, BUILDING_ALLIANCES, 2), _ref20))), _defineProperty(_GFI$interventions, SUPPORTING_FOOD_INNOVATION, new Intervention(_defineProperty({}, INFLUENCING_INDUSTRY, 2 * 2))), _defineProperty(_GFI$interventions, GOVERNMENT_OUTREACH, new Intervention((_ref22 = {}, _defineProperty(_ref22, INFLUENCING_POLICY_AND_THE_LAW, 2 * 2), _defineProperty(_ref22, BUILDING_ALLIANCES, 2 * 1), _ref22))), _defineProperty(_GFI$interventions, WORKING_IN_NEGLECTED_COUNTRIES, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2 * 2))), _GFI$interventions);
	...
	THL.criteria = (_THL$criteria = {}, _defineProperty(_THL$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(STRONG, MODERATE)), _defineProperty(_THL$criteria, COST_OF_EXPANSION_PLANS, new Criterion(STRONG, HIGH)), _defineProperty(_THL$criteria, TRACK_RECORD, new Criterion(STRONG, MODERATE)), _defineProperty(_THL$criteria, COST_EFFECTIVENESS, new Criterion(AVERAGE, MODERATE)), _defineProperty(_THL$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(STRONG, HIGH)), _defineProperty(_THL$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(STRONG, HIGH)), _defineProperty(_THL$criteria, CULTURE_AND_STRUCTURE, new Criterion(STRONG, HIGH)), _THL$criteria);

	THL.interventions = (_THL$interventions = {}, _defineProperty(_THL$interventions, GRASSROOTS_PROJECTS, new Intervention((_ref24 = {}, _defineProperty(_ref24, INFLUENCING_PUBLIC_OPINION, 2 * 1), _defineProperty(_ref24, CAPACITY_BUILDING, 2 * 1), _ref24))), _defineProperty(_THL$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 2))), _defineProperty(_THL$interventions, RESEARCH, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2))), _defineProperty(_THL$interventions, CORPORATE_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_INDUSTRY, 2 * 2))), _defineProperty(_THL$interventions, GOVERNMENT_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_POLICY_AND_THE_LAW, 2))), _defineProperty(_THL$interventions, WORKING_IN_NEGLECTED_COUNTRIES, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2 * 2))), _THL$interventions);
	...
	Faun.criteria = (_Faun$criteria = {}, _defineProperty(_Faun$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(AVERAGE, LOW)), _defineProperty(_Faun$criteria, COST_OF_EXPANSION_PLANS, new Criterion(WEAK, HIGH)), _defineProperty(_Faun$criteria, TRACK_RECORD, new Criterion(AVERAGE, MODERATE)), _defineProperty(_Faun$criteria, COST_EFFECTIVENESS, new Criterion(AVERAGE, LOW)), _defineProperty(_Faun$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(AVERAGE, MODERATE)), _defineProperty(_Faun$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(AVERAGE, MODERATE)), _defineProperty(_Faun$criteria, CULTURE_AND_STRUCTURE, new Criterion(STRONG, HIGH)), _Faun$criteria);

	Faun.interventions = (_Faun$interventions = {}, _defineProperty(_Faun$interventions, RESEARCH, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2 * 1 + 2 * 1 + 2 * 1 + 1))), _defineProperty(_Faun$interventions, MOVEMENT_STRENGTHENING, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2 * 1))), _Faun$interventions);
	...
	CIWF.criteria = (_CIWF$criteria = {}, _defineProperty(_CIWF$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(STRONG, LOW)), _defineProperty(_CIWF$criteria, COST_OF_EXPANSION_PLANS, new Criterion(WEAK, MODERATE)), _defineProperty(_CIWF$criteria, TRACK_RECORD, new Criterion(AVERAGE, MODERATE)), _defineProperty(_CIWF$criteria, COST_EFFECTIVENESS, new Criterion(WEAK, MODERATE)), _defineProperty(_CIWF$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(STRONG, MODERATE)), _defineProperty(_CIWF$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(STRONG, MODERATE)), _defineProperty(_CIWF$criteria, CULTURE_AND_STRUCTURE, new Criterion(STRONG, HIGH)), _CIWF$criteria);

	CIWF.interventions = (_CIWF$interventions = {}, _defineProperty(_CIWF$interventions, GRASSROOTS_PROJECTS, new Intervention(_defineProperty({}, INFLUENCING_POLICY_AND_THE_LAW, 2))), _defineProperty(_CIWF$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 1 + 1))), _defineProperty(_CIWF$interventions, RESEARCH, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2))), _defineProperty(_CIWF$interventions, CORPORATE_OUTREACH, new Intervention((_ref35 = {}, _defineProperty(_ref35, INFLUENCING_INDUSTRY, 2 * 2), _defineProperty(_ref35, BUILDING_ALLIANCES, 2 * 2), _ref35))), _CIWF$interventions);
	...
	FIAPO.criteria = (_FIAPO$criteria = {}, _defineProperty(_FIAPO$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(AVERAGE, MODERATE)), _defineProperty(_FIAPO$criteria, COST_OF_EXPANSION_PLANS, new Criterion(WEAK, HIGH)), _defineProperty(_FIAPO$criteria, TRACK_RECORD, new Criterion(AVERAGE, LOW)), _defineProperty(_FIAPO$criteria, COST_EFFECTIVENESS, new Criterion(STRONG, LOW)), _defineProperty(_FIAPO$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(AVERAGE, LOW)), _defineProperty(_FIAPO$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(AVERAGE, LOW)), _defineProperty(_FIAPO$criteria, CULTURE_AND_STRUCTURE, new Criterion(AVERAGE, LOW)), _FIAPO$criteria);

	FIAPO.interventions = (_FIAPO$interventions = {}, _defineProperty(_FIAPO$interventions, GRASSROOTS_PROJECTS, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 2 * 1))), _defineProperty(_FIAPO$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 2 * 1))), _defineProperty(_FIAPO$interventions, INFLUENCER_OUTREACH, new Intervention(_defineProperty({}, BUILDING_ALLIANCES, 1))), _defineProperty(_FIAPO$interventions, MOVEMENT_STRENGTHENING, new Intervention(_defineProperty({}, CAPACITY_BUILDING, 2 * 2))), _defineProperty(_FIAPO$interventions, INCREASE_VEGAN_OPTIONS, new Intervention((_ref40 = {}, _defineProperty(_ref40, INFLUENCING_INDUSTRY, 2), _defineProperty(_ref40, INFLUENCING_PUBLIC_OPINION, 1), _defineProperty(_ref40, BUILDING_ALLIANCES, 1), _ref40))), _defineProperty(_FIAPO$interventions, GOVERNMENT_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_POLICY_AND_THE_LAW, 2 * 2))), _FIAPO$interventions);
	...
	SVB.criteria = (_SVB$criteria = {}, _defineProperty(_SVB$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(AVERAGE, LOW)), _defineProperty(_SVB$criteria, COST_OF_EXPANSION_PLANS, new Criterion(WEAK, LOW)), _defineProperty(_SVB$criteria, TRACK_RECORD, new Criterion(STRONG, LOW)), _defineProperty(_SVB$criteria, COST_EFFECTIVENESS, new Criterion(AVERAGE, LOW)), _defineProperty(_SVB$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(STRONG, LOW)), _defineProperty(_SVB$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(AVERAGE, LOW)), _defineProperty(_SVB$criteria, CULTURE_AND_STRUCTURE, new Criterion(WEAK, LOW)), _SVB$criteria);

	SVB.interventions = (_SVB$interventions = {}, _defineProperty(_SVB$interventions, INCREASE_VEGAN_OPTIONS, new Intervention((_ref42 = {}, _defineProperty(_ref42, INFLUENCING_INDUSTRY, 2 * 4), _defineProperty(_ref42, BUILDING_ALLIANCES, 2 * 4), _ref42))), _defineProperty(_SVB$interventions, ORGANISING_CONFERENCES_AND_EVENTS, new Intervention((_ref43 = {}, _defineProperty(_ref43, INFLUENCING_PUBLIC_OPINION, 1), _defineProperty(_ref43, BUILDING_ALLIANCES, 2), _ref43))), _SVB$interventions);
	...
	SA.criteria = (_SA$criteria = {}, _defineProperty(_SA$criteria, IMPACTFULNESS_OF_PROGRAM, new Criterion(STRONG, LOW)), _defineProperty(_SA$criteria, COST_OF_EXPANSION_PLANS, new Criterion(WEAK, LOW)), _defineProperty(_SA$criteria, TRACK_RECORD, new Criterion(WEAK, LOW)), _defineProperty(_SA$criteria, COST_EFFECTIVENESS, new Criterion(AVERAGE, LOW)), _defineProperty(_SA$criteria, RESPONSE_TO_SUCCESS_AND_FAILURE, new Criterion(AVERAGE, LOW)), _defineProperty(_SA$criteria, LEADERSHIP_AND_STRATEGIC_VISION, new Criterion(AVERAGE, LOW)), _defineProperty(_SA$criteria, CULTURE_AND_STRUCTURE, new Criterion(AVERAGE, LOW)), _SA$criteria);

	SA.interventions = (_SA$interventions = {}, _defineProperty(_SA$interventions, ONLINE_AND_MEDIA_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 1))), _defineProperty(_SA$interventions, CORPORATE_OUTREACH, new Intervention(_defineProperty({}, INFLUENCING_INDUSTRY, 2 * 2))), _defineProperty(_SA$interventions, INVESTIGATIONS, new Intervention(_defineProperty({}, INFLUENCING_PUBLIC_OPINION, 1))), _SA$interventions);
	...
	interventions_question.filter = function (intervention_option) {
     ...
     `INTERVENTION_FILTER_MAX_OUTCOME_RANK`in the question `outcomes_question`. */
		...
		try {
			for (var _iterator10 = outcomes_question.options[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
				var outcome_option = _step10.value;
	...
	var CharityResultsPage = function () {
		...
		_createClass(CharityResultsPage, [{
			...
			value: function render() {
				...
				try {
					for (var _iterator12 = sorted_charities.entries()[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
						var _step12$value = _slicedToArray(_step12.value, 2);

						var index = _step12$value[0];
						var charity = _step12$value[1];
