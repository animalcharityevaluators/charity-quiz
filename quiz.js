  ...
  window.takeQuiz = function ($) {
    ...
    var Quiz = /*#__PURE__*/function () {
      ...
      _createClass(Quiz, [{
        ...
        value: function onSubmit() {
          ...
          $.post(this.post_url, data).done(function (data) {
    ...
    var Intervention = /*#__PURE__*/function () {
      function Intervention(display_name) {
        ...
        for (var _len2 = arguments.length, outcomes_influenced = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
      ...
      _createClass(Intervention, [{
        ...
        value: function score(weights) {
          var score = 0; // `weights`: of the form `Map({[MOVEMENT_BUILDING]: 4, [INCREASED_AVAILABILITY_OF_ANIMAL_FREE_PRODUCTS]: 5})`

          var _iterator5 = _createForOfIteratorHelper(this.outcomes_influenced),
              _step5;

          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              var outcome = _step5.value;
              ...
              if (!Array.isArray(outcome)) {
                ...
                var _iterator6 = _createForOfIteratorHelper(outcome.splice(1)),
                    _step6;

                try {
                  for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                    var indirect_outcome = _step6.value;
    ...
    var Charity = /*#__PURE__*/function () {
      ...
      _createClass(Charity, [{
        ...
        set: function set(dict) {
          ...
          for (var _i3 = 0, _Object$keys = Object.keys(dict); _i3 < _Object$keys.length; _i3++) {
        ...
        */
        ...
        value: function scoreCriteria(weights) {
          ...
          for (var _i4 = 0, _Object$entries2 = Object.entries(this.criteria); _i4 < _Object$entries2.length; _i4++) {
            var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i4], 2),
                key = _Object$entries2$_i[0],
                criterion = _Object$entries2$_i[1];
        ...
        value: function scoreInterventions(weights) {
          ...
          var _iterator7 = _createForOfIteratorHelper(flattened_entries(this.interventions)),
              _step7;
...
In general, we believe that GFF is an excellent giving opportunity because of their strong programmatic work and their commitment to community building in China.";
    GFF.links = {
      donation: "",
      //we're assuming we can't have a donation link to GFF, until we hear otherwise
...
capacity of the movement in relatively neglected regions.";
    ...
    AMG.description = "Consider <a target= \"_blank\" href=\"".concat(AMG.links.website, "\">learning more about</a> or <a target=\"_blank\" href=\"").concat(AMG.links.donation, "\">donating to</a> <b>ACE Movement Grants</b>.");
    ...
    var criteria_question = new RankQuestion("Which factors do you think are the most important for comparing different charities?", [new RankOption(PROGRAM, "Does the charity engage in programs that seem likely to be highly impactful?"), new RankOption(ROOM_FOR_MORE_FUNDING, "Will additional funding enable the charity to carry out high-impact activities that it could not pursue otherwise?"), new RankOption(COST_EFFECTIVENESS, "Does the charity operate its programs with a smaller budget relative to other charities we reviewed?"), new RankOption(TRACK_RECORD, "Does the charity have a record of achieving smaller goals, or has it demonstrated progress toward larger goals?"), new RankOption(LEADERSHIP_AND_CULTURE, "Does the charity have a strong leadership and a healthy organizational culture?"), new RankOption(ADAPTABILITY, "Does the charity have the capacity to respond to areas of success and failure appropriately?"), new RankOption(STRATEGY, "Does the charity have a clear and well-developed strategy?")], 5, true, false),
        ...
        interventions_question = new RankQuestion("Which interventions do you think most effectively achieve these outcomes?", [//new RankOption(
    //GRASSROOTS_PROJECTS,
    ...
    interventions_question.filter = function (intervention_option) {
      ...
      var _iterator8 = _createForOfIteratorHelper(charities),
          _step8;

      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          var charity = _step8.value;
          ...
          var _iterator9 = _createForOfIteratorHelper(interventions.map(function (intervention) {
      ...
      _createClass(CharityResultsPage, [{
        ...
        value: function render() {
          ...
          var first_choice = sorted_charities[0],
              ...
              $top_explanation = $("<p>").html("".concat(this.makeSuccessString(first_choice), " Use our <a href=\"https://forms.gle/5b3y2pvmZTnJHBZR7\" target=\"_blank\">feedback form</a> to let us know what you think about this quiz and your results.")),
          ...
          var _iterator10 = _createForOfIteratorHelper(sorted_charities.entries()),
              _step10;
        ...
        value: function makeSuccessString(charity) {
          ...
          if (top_criterion && charity.criteria[top_criterion.text].performance === STRONG) {
            ret += "".concat(charity.uses_article ? "The " : "", "<b>").concat(charity.name, "</b> performs strongly in our assessment of ").concat(Criterion.READOUT_NAMES.get(top_criterion.display_name(charity)), ".");
          }

          if (top_outcome && intervention_names_for_boast.length > 0) {
            ret += ret ? "They also work" : "".concat(charity.uses_article ? "The " : "", "<b>").concat(charity.name, "</b> works");
            ret += " toward ".concat(top_outcome.display_name(charity).toLowerCase(), " through ").concat(intervention_names_for_boast.join(" and "), ".");
          }

          if (ret) return ret;
          return "The charity which most closely matches your preferences is ".concat(charity.uses_article ? "the " : "", "<b>").concat(charity.name, "</b>.");
        }
      }, {
